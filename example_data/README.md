...
The file naming convention for data files is described below using the following fields:
...
- `{percentile}` the threshold percentile used in likelihood calculations (e.g. `98-0p` is the 98th percentile or 1-in-50 year event)
